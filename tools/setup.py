...
def main():
    ...
    print("""
  ######################################
  # BBA Development Environment Setup #
  ######################################

  This script will create your BBA dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your BBA project folder:
    [Arma 3 installation directory]\\{} => BBA project folder
    P:\\{}                              => BBA project folder
